...
public class KafkaBeanConfig {
    ...
    public KafkaAdmin kafkaAdmin() {
        ...
        configs.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, appConfig.getKafka().getBootstrapServers());
    ...
    public ProducerFactory<String, String> producerFactory() {
        ...
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, appConfig.getKafka().getBootstrapServers());
